...
class SegnaleticaCartelliEsterni(models.Model):
    _name = 'edificio.segnaleticacartelliesterni'
    ...
    name= fields.Char(string='segnaleticaCartelliEsterni ID', required=True)
